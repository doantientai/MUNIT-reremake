...
# parser.add_argument('--a2b', type=int, default=1, help="1 for a2b and 0 for b2a")
# parser.add_argument('--input', type=str, default='/home/jupyter/workdir/TaiDoan/Projects/InfoMUNIT_workshop/Data/edges2handbags/testA/100_AB.jpg')
# parser.add_argument('--output_folder', default='/home/jupyter/workdir/TaiDoan/Projects/InfoMUNIT_workshop/Models/003_edge2bag_64/tests/test_latent/a2b/100', type=str)
# # parser.add_argument('--a2b', type=int, default=0, help="1 for a2b and 0 for b2a")
# # parser.add_argument('--input', type=str, default='/media/tai/6TB/Projects/InfoMUNIT/Data/CityScapes/split/testB/63.jpg')
# # parser.add_argument('--output_folder', default='/media/tai/6TB/Projects/InfoMUNIT/Models/ver_workshop/012_MUNIT_origin_cityscapes_64_cyc/tests/test_latent/b2a/63', type=str)
...
# # parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/003_edge2bag_64/tests/test_latent_aim/a2b/23', type=str)
# parser.add_argument('--a2b', type=int, default=0, help="1 for a2b and 0 for b2a")
# parser.add_argument('--input', type=str, default=path_InfoMUNIT_workshop+'Data/edges2handbags/testB/100_AB.jpg')
# parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/003_edge2bag_64/tests/test_latent_aim/b2a/100', type=str)
...
# parser.add_argument('--a2b', type=int, default=1, help="1 for a2b and 0 for b2a")
# parser.add_argument('--input', type=str, default=path_InfoMUNIT_workshop+'Data/edges2handbags/testA/23_AB.jpg')
# parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/005_MUNIT_origin_edge2bag_64/tests/test_latent_aim_r2/a2b/23', type=str)
parser.add_argument('--a2b', type=int, default=0, help="1 for a2b and 0 for b2a")
parser.add_argument('--input', type=str, default=path_InfoMUNIT_workshop+'Data/edges2handbags/testB/100_AB.jpg')
parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/005_MUNIT_origin_edge2bag_64/tests/test_latent_aim_r2/b2a/100', type=str)
...
# parser.add_argument('--a2b', type=int, default=1, help="1 for a2b and 0 for b2a")
# parser.add_argument('--input', type=str, default=path_InfoMUNIT_workshop+'Data/edges2shoes/testA/143_AB.jpg')
# parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/004_edge2shoe_64/tests/test_latent_aim_r2/a2b/143', type=str)
...
# parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/006_MUNIT_origin_edge2shoe_64/tests/test_latent_aim_r2/a2b/10', type=str)
...
# # parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/019_InfoMUNIT_dog2catDRIT_64/tests/test_latent_aim_100k/a2b/28', type=str)
# parser.add_argument('--a2b', type=int, default=0, help="1 for a2b and 0 for b2a")
# parser.add_argument('--input', type=str, default=path_InfoMUNIT_workshop+'Data/Dog2CatDRIT/cat2dog/testB/120.jpg')
# parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/019_InfoMUNIT_dog2catDRIT_64/tests/test_latent_aim_100k/b2a/120', type=str)
...
# parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/018_MUNIT_origin_dog2catDRIT_64/tests/test_latent_aim_100k/a2b/499', type=str)
# # parser.add_argument('--a2b', type=int, default=0, help="1 for a2b and 0 for b2a")
# # parser.add_argument('--input', type=str, default=path_InfoMUNIT_workshop+'Data/Dog2CatDRIT/cat2dog/testB/1382.jpg')
# # parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/018_MUNIT_origin_dog2catDRIT_64/tests/test_latent_aim_100k/b2a/1382', type=str)
...
# # parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/020_MUNIT_portrait_64/tests/test_latent_aim_200k/a2b/jean-francois-millet_louise-antoinette-feuardent-1841', type=str)
# parser.add_argument('--a2b', type=int, default=0, help="1 for a2b and 0 for b2a")
# parser.add_argument('--input', type=str, default=path_InfoMUNIT_workshop+'Data/portrait/testB/089330.jpg')
# parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/020_MUNIT_portrait_64/tests/test_latent_aim_200k/b2a/089330', type=str)
...
# parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/022_InfoMUNIT_portrait_64/tests/test_latent_aim_200k/a2b/george-stubbs_portrait-of-richard-wedgewood', type=str)
# # parser.add_argument('--a2b', type=int, default=0, help="1 for a2b and 0 for b2a")
# # parser.add_argument('--input', type=str, default=path_InfoMUNIT_workshop+'Data/portrait/testB/105059.jpg')
# # parser.add_argument('--output_folder', default=path_InfoMUNIT_workshop+'Models/022_InfoMUNIT_portrait_64/tests/test_latent_aim_200k/b2a/105059', type=str)
