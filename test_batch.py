...
### test limited labels
parser.add_argument('--a2b', type=int, default=0, help="1 for a2b and 0 for b2a")
parser.add_argument('--config', default='/media/tai/6TB/Projects/InfoMUNIT/Models/MUNIT-reremake/MUNIT_CC6l_LL1k/outputs/mnist2svhn_002_infoStyle/config.yaml', type=str, help="net configuration")
# parser.add_argument('--num_style', type=int, default=1, help="number of styles to sample")
parser.add_argument('--output_only', default=True, help="whether only save the output images or also save the input images")
...
# parser.add_argument('--output_folder', default='/media/tai/6TB/Projects/InfoMUNIT/Data/ForMUNIT/mnist2svhn_w_labels/augmented_by_infoMUNIT/MUNIT_CC6l_1shot/ckpt320k/trainA_10_B_full_generated/'+str(label), type=str, help="output image path")
# LIMIT_SAMPLE = None

# ### CC4 20 shots
# parser.add_argument('--checkpoint', default='/media/tai/6TB/Projects/InfoMUNIT/Models/MUNIT-reremake/MUNIT_CC4l_LL200/gen_00370000.pt', type=str, help="checkpoint of autoencoders")
# parser.add_argument('--output_folder', default='/media/tai/6TB/Projects/InfoMUNIT/Data/ForMUNIT/mnist2svhn_w_labels/augmented_by_infoMUNIT/MUNIT_CC4l_200/ckpt370k/trainA_200_B_full_generated/'+str(label), type=str, help="output image path")
# LIMIT_SAMPLE = None
